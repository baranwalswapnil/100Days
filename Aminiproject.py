...
# # starting ka yes/no
# first_answer = input("Hi Jahnavi! 😊 Can I ask you a quick question? (yes/no): ").strip().lower()
...
#     print("\nI'm waiting for your answer, Jahnavi! 💌")
#     print()

#     #response
#     answer = input("Are you coming, bubu? 😶😶 (yes/no): ").strip().lower()
